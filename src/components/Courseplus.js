...
export default function Courseplus() {
  return (
    <>
        ...
        <div className="conj2">
        <button type="button" class="btn koke btn-outline-success my-4"><div class="fs-2 mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-plus-circle" viewBox="-2 -2 25 25">
